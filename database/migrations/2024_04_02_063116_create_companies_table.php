...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('companies', function (Blueprint $table) {
            ...
            // $table->smallInteger('sales_dept_status')->default(0)->comment('0-Pending,1-Completed');
            $table->longText('spare_note')->nullable();
            // $table->unsignedBigInteger('spare_dept_person_id')->nullable()->comment('0-All');
            // $table->smallInteger('spare_dept_status')->default(0)->comment('0-Pending,1-Completed');
            $table->longText('service_note')->nullable();
            // $table->unsignedBigInteger('service_dept_person_id')->nullable()->comment('0-All');
            // $table->smallInteger('service_dept_status')->default(0)->comment('0-Pending,1-Completed');
