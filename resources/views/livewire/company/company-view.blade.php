    ...
    <div class="row mt-5 mb-2">
        ...
        <div class="col-6  text-end">
         <div class="form-btn-group">
            <a class="btn btn-outline-dark" href="{{ App\Helpers\AppHelper::getPreviousUrl('company-list') }}" wire:navigate>Back</a>
         </div>
        </div>
    </div>
    <div class="card p-3">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" wire:model="form.customer_satisfaction" disabled>
                                <option value="">-Select-</option>
